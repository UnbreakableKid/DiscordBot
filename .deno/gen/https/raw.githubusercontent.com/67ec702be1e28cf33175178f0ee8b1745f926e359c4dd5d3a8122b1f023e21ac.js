...
/** Remove a role from the member */ export async function removeRole(guildId, memberId, roleId, reason) {
    ...
    return await rest.runMethod("delete", endpoints.GUILD_MEMBER_ROLE(guildId, memberId, roleId), {
        reason
    });
}
