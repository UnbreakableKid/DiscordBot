 ...
 */ app.use = function use(...args) {
    ...
    const [path, ...nonPathArgs] = (Array.isArray(firstArg) ? isPath(firstArg[0]) : isPath(firstArg)) ? args : [
        "/",
        ...args
    ];
 ...
 */ app.listen = function listen(options, callback) {
    ...
    const isTlsOptions = typeof options !== "string" && typeof options.certFile !== "undefined";
