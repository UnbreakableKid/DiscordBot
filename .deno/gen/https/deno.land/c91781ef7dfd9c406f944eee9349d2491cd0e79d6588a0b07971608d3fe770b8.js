 ...
 */ function validatePath(path) {
  ...
  for (let i = 0; i < path.length; i++) {
    ...
    if (
      c < String.fromCharCode(32) || c > String.fromCharCode(126) || c == ";"
    ) {
 ...
 */ function validateCookieValue(name, value) {
  ...
  for (let i = 0; i < value.length; i++) {
    ...
    if (
      c < String.fromCharCode(33) || c == String.fromCharCode(34) ||
      c == String.fromCharCode(44) || c == String.fromCharCode(59) ||
      c == String.fromCharCode(92) || c == String.fromCharCode(127)
    ) {
      throw new Error(
