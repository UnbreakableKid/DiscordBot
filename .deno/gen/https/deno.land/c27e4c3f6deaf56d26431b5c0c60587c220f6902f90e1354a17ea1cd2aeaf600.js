...
export class SabrTable {
  ...
  /** Gets the first document from a table that match a filter */ async findOne(
    filter,
  ) {
    for await (
  ...
  /** Updates a documents data. If this document does not exist, it will create the document. */ async update(
    id,
    data = {},
  ) {
  ...
  /** Gets the first document from a table that match a filter */ async updateOne(
    filter,
    data,
  ) {
    for await (
  ...
  /** Deletes one document in a table that match a filter */ async deleteOne(
    filter,
  ) {
    const files = Deno.readDirSync(
      Deno.realPathSync(`${this.sabr.directoryPath}${this.name}`),
  ...
  /** Deletes all documents in a table that match a filter */ async deleteMany(
    filter,
  ) {
    const files = Deno.readDirSync(
      Deno.realPathSync(`${this.sabr.directoryPath}${this.name}`),
