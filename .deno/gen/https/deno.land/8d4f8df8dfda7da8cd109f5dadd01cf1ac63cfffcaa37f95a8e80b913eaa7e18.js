var STATUS;
(function(STATUS) {
    STATUS[STATUS[/* Allowed flush values; see deflate() and inflate() below for details */ "Z_NO_FLUSH"] = 0] = "Z_NO_FLUSH";
    ...
    STATUS[STATUS[/* Return codes for the compression/decompression functions. Negative values
  ...
  */ "Z_OK"] = 0] = "Z_OK";
    ...
    STATUS[STATUS[//Z_MEM_ERROR=     -4,
    "Z_BUF_ERROR"] = -5] = "Z_BUF_ERROR";
    STATUS[STATUS[//Z_VERSION_ERROR= -6,
    /* compression levels */ "Z_NO_COMPRESSION"] = 0] = "Z_NO_COMPRESSION";
    ...
    STATUS[STATUS[/* Possible values of the data_type field (though see inflate()) */ "Z_BINARY"] = 0] = "Z_BINARY";
    STATUS[STATUS["Z_TEXT"] = 1] = "Z_TEXT";
    STATUS[STATUS[//Z_ASCII=                1, // = Z_TEXT (deprecated)
    "Z_UNKNOWN"] = 2] = "Z_UNKNOWN";
    STATUS[STATUS[/* The deflate compression method */ "Z_DEFLATED"] = 8] = "Z_DEFLATED";
})(STATUS || (STATUS = {
}));
