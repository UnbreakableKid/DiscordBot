...
/** This function should be used when you want to convert milliseconds to a human readable format like 1d5h. */ export function humanizeMilliseconds(
  milliseconds,
) {
...
/** This function helps convert a string like 1d5h to milliseconds. */ export function stringToMilliseconds(
  text,
) {
...
//   command.subcommands.set(subcommand.name, subcommand);
// }
/** Use this function to send an embed with ease. */ export function sendEmbed(
  channelId,
  embed,
  content,
) {
...
/** Use this function to edit an embed with ease. */ export function editEmbed(
  message,
  embed,
  content,
) {
...
let paths = [];
/** This function allows reading all files in a folder. Useful for loading/reloading commands, monitors etc */ export async function importDirectory(
  path,
) {
...
/** This function allows to create a pagination using embeds and reactions Requires GUILD_MESSAGE_REACTIONS intent **/ export async function createEmbedsPagination(
  channelId,
  authorId,
  embeds,
  defaultPage = 1,
...
/** This function allows to create a pagination using embeds and buttons. **/ export async function createEmbedsButtonsPagination(
  messageId,
  channelId,
  authorId,
  embeds,
